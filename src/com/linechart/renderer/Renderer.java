...
public abstract class Renderer {
	...
	protected void calcXBounds(Transformer trans) {
		double minx = trans.getValuesByTouchPoint(this.mViewPortHandler.contentLeft(), 0.0F).x;
		double maxx = trans.getValuesByTouchPoint(this.mViewPortHandler.contentRight(), 0.0F).x;
