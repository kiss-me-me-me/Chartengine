...
public abstract class Utils {
	...
	private static final int[] POW_10 = new int[] { 1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000,
			1000000000 };
	...
	public static int getClosestDataSetIndex(List<SelInfo> valsAtIndex, float val, AxisDependency axis) {
		int index = -1;
	...
	public static float getMinimumDistance(List<SelInfo> valsAtIndex, float val, AxisDependency axis) {
		float distance = 3.4028235E38F;
	...
	public static String getFourDecimal(float value) {
		DecimalFormat df = new DecimalFormat("0.0000");
		return df.format(value);
	}
	
	public static String getFourDecimal(double value) {
		DecimalFormat df = new DecimalFormat("0.0000");
		return df.format(value);
	}
}
